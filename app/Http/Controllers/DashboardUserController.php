...
class DashboardUserController extends Controller
{
    ...
    public function index()
    {
        ...
        $acr = Acara::simplePaginate(6);
        return view('users.dashboard.dashboard', compact('acr'));
    }
    ...
    {
        $acr = Acara::find($id);
        return view('users.dashboard.detail_user', compact('acr'));
    }
    ...
    public function cetak_pdf()
    {
    	...
    	$pdf = Pdf::loadview('users.dashboard.acara_pdf',['acr'=>$acr]);
    	return $pdf->download('laporan-Acara.pdf');
    }
}
