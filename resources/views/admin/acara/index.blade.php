  ...
  <div class="col-lg-4 col-md-12 col-6 mb-4">
    <div class="card card-gradient" style="max-height: 150px">
      <div class="card-body">
        ...
        <h3 class="card-title mb-2">{{ $acrs }}</h3>
      </div>
    </div>
  </div>
  <div class="col-lg-4 col-md-12 col-6 mb-4">
        ...
        <form method="post" action="{{ route('acara.store')}}" id="myForm" enctype="multipart/form-data">
          ...
          <div class="mb-3">
            ...
            <div class="input-group input-group-merge">
              ...
              <input type="text" id="basic-icon-default-name" name="name" class="form-control" placeholder="Judul Acara"
        ...
        <div class="col-md-8">
          <div class="card-body">
            <div class="d-flex justify-content-between">
              <h5 class="card-title">{{ Str::limit($acara->name, 15) }}</h5>
              <div class="dropdown">
                <button class="btn p-0" type="button" id="cardOpt3" data-bs-toggle="dropdown" aria-haspopup="true"
                  aria-expanded="false">
                  <i class="bx bx-dots-vertical-rounded"></i>
                ...
                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt3">
                  ...
                  <form action="{{ route('acara.destroy', $acara->id) }}" method="POST" class="d-inline">
                    @csrf
                    @method('DELETE')
                    <button type="submit" class="dropdown-item gradient-delete rounded">Delete</button>
                </form>
                </div>
              </div>
            </div>
